...
* [`src/irish_tutor/`](src/irish_tutor/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/irish_tutor/core.cljs): contains the SPA entry point, `init`
...
The `debug?` variable in [`config.cljs`](src/cljs/irish_tutor/config.cljs) defaults to `true` in
